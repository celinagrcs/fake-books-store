...
const InstructionsModal = ({ onClose }) => {
  ...
  return (
    ...
    <div className="relative bg-white p-8 rounded shadow-md w-full max-w-md animate-fadeInUp">
      <button 
      ...
      <p className="text-center mb-2 mt-5 ">Holi, soy Pucho, el pingüino. ¡Te propongo un desafío!
